...
def get_vla(cfg):
    ...
    spatial_norm_stats = {'libero_spatial': {'action': {'mean': [0.00023341942869592458, 0.00013004851643927395, -0.0001276239490834996, -0.00015565496869385242, -0.0004039342748001218, 0.00023557787062600255, 0.5764579176902771], 
                                                'std': [0.0097659258171916, 0.013689117506146431, 0.012667356990277767, 0.0285343024879694, 0.03063800372183323, 0.07691463828086853, 0.4973685145378113], 
                                                'max': [0.41691166162490845, 0.25864794850349426, 0.21218234300613403, 3.122201919555664, 1.8618112802505493, 6.280478477478027, 1.0], 
                                                'min': [-0.4007510244846344, -0.13874775171279907, -0.22553899884223938, -3.2010786533355713, -1.8618112802505493, -6.279075622558594, 0.0], 
                                     ...
                                     'num_transitions': 2135463, 'num_trajectories': 60064}}
    vla.norm_stats["norm_stats"] = spatial_norm_stats
