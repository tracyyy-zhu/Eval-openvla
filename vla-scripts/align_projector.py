...
class TrainConfig:
    ...
    # Tracking Parameters
    trackers: Tuple[str, ...] = ("jsonl", "wandb") #flag               # Trackers to initialize (if W&B, add config!)
    ...
    def __post_init__(self) -> None:
        ...
        self.global_batch_size = 32 #self.vla.global_batch_size #flag
        self.per_device_batch_size = 32 #self.vla.per_device_batch_size #32 flag
...
def train(cfg: TrainConfig) -> None:
    ...
    # for name, m in train_strategy.vlm.named_modules():
    #     if isinstance(m, FSDP):
    #         # _use_orig_params is a private attr but reliable for debugging
    #         print(f"[FSDP] {name or '<ROOT>'} "
    #               f"wraps={type(m.module).__name__} "
